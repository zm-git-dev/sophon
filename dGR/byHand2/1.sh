...
./../reBuildDGR.pl mm/out.gtf train/DGR.fa 1.txt 2.txt 0.5 3 30
number=$(grep "DGR" 1.txt |wc -l)
TP_train_intact=`echo "scale=4; $number / $train" | bc`
...
./../reBuildDGR.pl mm/out.gtf test/DGR.fa 1.txt 2.txt 0.5 3 30
number=$(grep "DGR" 1.txt |wc -l)
TP_test_intact=`echo "scale=4; $number / $test" | bc`
...
./../reBuildDGR.pl mm/out.gtf ../random/5kbp.fa 1.txt 2.txt 0.5 3 30
number=$(grep "DGR" 1.txt |wc -l)
FPR_intact=`echo "scale=4; $number / 10000" | bc`
